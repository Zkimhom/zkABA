...
return fileList;
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] facedata = new String[2500];
        ...
        for(int i=0;i<2500;i++){
            ...
            facedata[i]=faceFeature.getFeatureData().toString();
           ...
           //人脸检测
            ...
            for (int j = 0; j <2500; j++) {
                ...
                if(j<=i)
                    continue;
                //人脸检测2
                ImageInfo imageInfo2 = getRGBData(new File(list[j]));
                ...
                if (Math.abs(j-i)<=4 && faceSimilar.getScore()>=threshold )
                    TP++;
                else if (Math.abs(j-i)<=4 && faceSimilar.getScore()<threshold)
                    FN++;
                else if (Math.abs(j-i)>4 && faceSimilar.getScore()>=threshold)
                    FP++;
                else if (Math.abs(j-i)>4 && faceSimilar.getScore()<threshold)
